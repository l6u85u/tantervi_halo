export class Subject {
    ...
    constructor(code: string, name: string, credit: number, type: string = "", status: Status = 0, pre: Array<Prerequisite> = [], over: Array<Subject> = [], border: number = 0, proposedSemester: number = 0, spec: string = "", ken: string = "", isAvailable: boolean = false) {
        this._code = code
        this._name = name
        this._credit = credit
        this._type = type
