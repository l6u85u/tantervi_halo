...
describe('Curriculum', () => {
  ...
  describe(".setSubjectAvailability(subj)", function () {
    ...
    it('should set availability to true (all prerequisites are completed)', () => {
      ...
      curriculum.semesters[1].subjects[2].status = Status.Completed
      curriculum.semesters[0].subjects[0].status = Status.Completed
  ...
  describe(".moveSubjectToSemester(prevColumnIdx, columnIdx, prevIdx, currentIdx)", function () {
    let resp: any
    ...
    it('should move subject to a new semester', () => {
      ...
      curriculum.moveSubjectToSemester(0, 5, 7, 1)
    ...
    it('should move subject to a new index in the same semester', () => {
      ...
      curriculum.moveSubjectToSemester(0, 0, 0, 5)
  ...
  describe(".changeSubjectStatus(subj, idx)", function () {
    ...
    it('should change the status from not enrolled to enrolled', () => {
      ...
      expect(subject.status).toBe(Status.NotEnrolled);
      curriculum.changeSubjectStatus(subject, 0)
      expect(subject.status).toBe(Status.Enrolled);
    });
    ...
    it('should change the status from enrolled to completed', () => {
      ...
      curriculum.changeSubjectStatus(subject, 0)
      expect(subject.status).toBe(Status.Completed);
    });
    ...
    it('should update the status of overlay subjects when changing the status from completed to not enrolled', () => {
      ...
      curriculum.semesters[1].subjects[0].status = Status.Completed
      curriculum.semesters[0].subjects[2].status = Status.Completed
      ...
      expect(curriculum.enrolledCreditsPerc).toBe("0%")
      expect(curriculum.completedCreditsPerc).toBe("0%")
      expect(curriculum.semesters[3].subjects[0].status).toBe(Status.NotEnrolled)
      expect(curriculum.semesters[1].subjects[2].status).toBe(Status.NotEnrolled)
    });
  ...
  describe(".updateCredits()", function () {
    ...
    it('should recalculate the credits from scratch', () => {
      ...
      curriculum.semesters[0].subjects[0].status = Status.Completed
      curriculum.semesters[1].subjects[0].status = Status.Completed
      curriculum.semesters[2].subjects[0].status = Status.Completed
      curriculum.semesters[3].subjects[0].status = Status.Completed
      curriculum.semesters[4].subjects[0].status = Status.Completed

      curriculum.semesters[0].subjects[7].status = Status.Enrolled
      curriculum.semesters[1].subjects[8].status = Status.Enrolled
      curriculum.semesters[2].subjects[8].status = Status.Enrolled
      curriculum.semesters[3].subjects[10].status = Status.Enrolled
      curriculum.semesters[4].subjects[7].status = Status.Enrolled
  ...
  describe(".updateCurrentSubjectCode(newValue)", function () {
    ...
    it('should hide the overlays of the old subject', () => {
      curriculum.updateCurrentSubjectCode("IP-18OEPROGEG")
      curriculum.semesters[1].subjects[1].status = Status.Completed
